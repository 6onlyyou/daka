...
class JsonConvert<T> {
  ...
  static _getFromJson<T>(Type type, data, json) {
    switch (type) {			case FansDataModel:
			return fansDataModelFromJson(data as FansDataModel, json) as T;			case HisListModel:
			return hisListModelFromJson(data as HisListModel, json) as T;			case HisListData:
			return hisListDataFromJson(data as HisListData, json) as T;			case FansListModel:
  ...
  static _getToJson<T>(Type type, data) {
		switch (type) {			case FansDataModel:
			return fansDataModelToJson(data as FansDataModel);			case HisListModel:
			return hisListModelToJson(data as HisListModel);			case HisListData:
			return hisListDataToJson(data as HisListData);			case FansListModel:
  ...
  static _fromJsonSingle(String type, json) {
    switch (type) {			case 'FansDataModel':
			return FansDataModel().fromJson(json);			case 'HisListModel':
			return HisListModel().fromJson(json);			case 'HisListData':
			return HisListData().fromJson(json);			case 'FansListModel':
  ...
  static _getListFromType(String type) {
    switch (type) {			case 'FansDataModel':
			return List<FansDataModel>();			case 'HisListModel':
			return List<HisListModel>();			case 'HisListData':
			return List<HisListData>();			case 'FansListModel':
